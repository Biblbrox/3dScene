...
PCLViewer::PCLViewer(QMainWindow *parent) :
        QMainWindow(parent), m_ui(new Ui::PCLViewer)
{
    m_ui->setupUi (this);
...
//    complexCloud.drawIntensityCloud();
    ...
    connect (m_ui->horizontalSlider_G, SIGNAL (valueChanged (int)), this, SLOT (initialDistanceChanged (float)));
    connect (m_ui->horizontalSlider_B, SIGNAL (valueChanged (int)), this, SLOT (maxDistanceChanged (float)));
    ...
    connect (m_ui->horizontalSlider_p, SIGNAL (valueChanged (int)), this, SLOT (windowSizeChanged (int)));
